...
@endsection
          ...
          @if ($JumlahDataPenulis>0)
            <div class="alert alert-success">Ditemukan {{ $JumlahDataPenulis}} data dengan kata kunci : {{$cari}}</div>        
                  ...
                  <div class="alert alert-danger">Data dengan kata kunci : {{$cari}} Tidak Ditemukan
                      <a href="{{url('/penulis')}}"><input type="button" class="btn btn-danger" value="Klik Disini untuk kembali"></a>
                  </div>
                  @endif
                  </div>
                <ul class="pagination">
